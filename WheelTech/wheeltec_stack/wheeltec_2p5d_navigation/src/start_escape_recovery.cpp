...
class StartEscapeRecovery : public nav_core::RecoveryBehavior {
 public:
  ...
  void initialize(std::string name, tf2_ros::Buffer*,
    ...
    private_nh.param("rear_min_x", rear_min_x_, -0.70);
    private_nh.param("rear_max_x", rear_max_x_, -0.15);
    private_nh.param("rear_half_width", rear_half_width_, 0.35);
 ...
 private:
  ...
  double rear_min_x_ = -0.70;
  double rear_max_x_ = -0.15;
  double rear_half_width_ = 0.35;
...
PLUGINLIB_EXPORT_CLASS(wheeltec_2p5d_navigation::StartEscapeRecovery,
