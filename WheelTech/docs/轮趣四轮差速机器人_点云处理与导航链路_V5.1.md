...
| FAST-LIO配置入口 | `wheeltec_system_bringup/launch/fastlio_mapping_wheeltec.launch` |
...
启动：`wheeltec_system_bringup/launch/wheeltec_relocalization.launch`。
...
| 位姿/注册点云 | `fast_lio/laserMapping` | `launch/fastlio_mapping_wheeltec.launch` |
...
| NDT定位 | `fast_lio_localization/wheeltec_global_localizer` | `src/fast_lio_localization.cpp`、`wheeltec_relocalization.launch` |
