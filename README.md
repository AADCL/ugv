...
| WheelTech | 轮趣四轮差速底盘、Jetson NX、Livox Mid-360、Orbbec Gemini 336L | 串口底盘控制、FAST-LIO2/PCD 建图、NDT 重定位、持久化 2.5D 地图、TerrainGlobalPlanner、TEB 与 RGB-D 接入 | [项目 README](WheelTech/README.md) · [V4.0 文档](WheelTech/docs/) |
